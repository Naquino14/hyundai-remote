...
fob:
	west build -b heltec_wifi_lora32_v3/esp32s3/procpu --sysbuild -s app -p auto -- -DCONFIG_DEVICE_ROLE=1 -DBOARD_ROOT=$(CWD) -DDTC_OVERLAY_FILE=$(CWD)/app/src/boards/heltec_wifi_lora32_v3.overlay
